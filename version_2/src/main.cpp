...
boost::unordered_map<UINT32, addresses_t> inputaddrs_affecting_cbranch_at_execorder;
...
boost::unordered_map<UINT32, UINT32> target_execorder_of_bridge_at_execorder;
